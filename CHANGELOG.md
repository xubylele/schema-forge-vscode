...
- 0a34b3e: ✨ feat: Add migration planning and preview workflows to the VS Code extension, plus clearer index/view diff UX.
...
- 16c8751: ✨ feat(extension): add RLS policy snippet and syntax highlighting support

  - Introduce RLS policy snippet for faster authoring in the extension.
  - Add syntax highlighting support for Schema Forge DSL.
  - Add new launch configuration for running the extension with a clean profile.
  - Update README to improve syntax highlighting and snippets documentation.

## 0.4.2

### Patch Changes

- 8eb6294: ⬆️ chore(deps): upgrade core dependency and improve CI workflows

  - Upgrade `@xubylele/schema-forge-core` to `1.5.0`.
  - Update `README.md` with new features and compatibility for VS Code `1.70.0+`.
  - Upgrade GitHub Actions to `actions/checkout@v5` and `actions/setup-node@v5`.
